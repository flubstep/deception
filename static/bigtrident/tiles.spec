...
artists = "
    ...
    maubp <freeciv(at)maubp.freeserve.co.uk> (original bigtrident tiles)
    Bjorn Michaelsen <bmichaelsen@gmx.de> (vectorized trident)
    Yautja (fallout sprite)
    Eleazar (buoy)
    Vincent Croisier <vincent.croisier@advalvas.be> (ruins)
"

[file]
gfx = "bigtrident/tiles"
